...
<body>
    ...
    <script>
        ...
        function initMap() {
            ...
            $sql = "SELECT sp_nosaukums, latitude, longitude FROM sporta_laukums";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "L.marker([$latitude, $longitude]).addTo(map)"
                        . ".bindPopup('<b>' + $encoded_sp_nosaukums + '</b><br><a href=\"apraksts.php?sp_nosaukums=$sp_nosaukums\">Details</a>')";
